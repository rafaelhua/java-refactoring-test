...
class UserDaoImplTest {
	...
	@Test
	void updateUser_shouldKeepEmailAndChangeRoles() {
		UserDaoImpl userDao = new UserDaoImpl();
		userDao.saveUser(new User(TEST_USER_NAME, TEST_USER_EMAIL, TEST_USER_ROLES));

		userDao.updateUser(TEST_USER_EMAIL, new User(TEST_USER_NAME, "ignored@example.com", List.of("user")));

		User updatedUser = userDao.findUser(TEST_USER_EMAIL);
